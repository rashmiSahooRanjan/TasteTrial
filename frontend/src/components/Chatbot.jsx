...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hello! I am a highly responsible and helpful AI assistant powered by TasteTrail. Ask me anything, and I'll do my best to provide you with an accurate and complete answer.",
      isBot: true,
      timestamp: new Date()
    }
  ]);
  ...
  useEffect(() => {
    if (messages.length > 1) {
      sessionStorage.setItem('TasteTrailChatHistory', JSON.stringify(messages));
    }
  }, [messages]);
      ...
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-[9998] w-[85vw] sm:w-[380px] h-[500px] sm:h-[550px] bg-white rounded-2xl shadow-2xl flex flex-col border-2 border-[#ff4d2d] overflow-hidden">
          ...
          <div className="bg-[#ff4d2d] text-white p-3 flex items-center justify-between">
            <h2 className="text-base sm:text-lg font-bold">TasteTrail Chatbot</h2>
            <button
